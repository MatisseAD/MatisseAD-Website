...
export default function Component() {
  ...
  const totalDownloads = modrinthProjects.reduce((sum, project) => sum + project.downloads, 0)
  const averageRating = modrinthProjects.length > 0 ? 4.7 : 0 // Modrinth doesn't provide ratings in API
            ...
            <div className="flex-1 space-y-3">
              <div>
                <h1 className="text-3xl font-bold">
                  {githubUser?.name || githubUser?.login || modrinthUser?.username}
                </h1>
      ...
      <div className="grid md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-2 gap-4 text-center">
              <div>
                <div className="text-2xl font-bold text-primary">{modrinthProjects.length}</div>
              ...
              <div>
                <div className="text-2xl font-bold text-primary">
                  {modrinthProjects.reduce((sum, project) => sum + project.followers, 0)}
                </div>
                <div className="text-xs text-muted-foreground">Followers</div>
              </div>
            </div>
            ...
            <div className="space-y-3">
              ...
              <div className="space-y-2 text-sm">
                {modrinthProjects.slice(0, 3).map((project) => (
        ...
        <Card>
          ...
          <CardContent className="space-y-3">
            ...
            <Button variant="outline" className="w-full justify-start" asChild>
              <a href={`https://modrinth.com/user/${modrinthUser?.username}`} target="_blank" rel="noopener noreferrer">
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-2">
                      ...
                      <div>
                        ...
                        <CardDescription className="text-sm">{project.categories.join(", ")}</CardDescription>
                      </div>
                    </div>
                    <Badge
                      className={
